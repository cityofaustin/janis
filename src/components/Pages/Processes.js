...
const Processes = ({ processes, intl }) => (
  <div>
    <div className="wrapper wrapper--sm container-fluid">
      <PageHeader
        title="Use City of Austin Processes"
        description="The City of Austin provides hundreds of services to people. This is a short list of processes that will grow over time."
      />
    </div>
