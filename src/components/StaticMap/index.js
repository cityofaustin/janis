...
import { contact as i18ncontact, navigation as i18nnavigation } from 'js/i18n/definitions';
  ...
  return (
    <div className="coa-StaticMap">
      <a
        ...
        aria-label={intl.formatMessage(i18nnavigation.openInNewWindow)}
      >
        <img
          ...
          alt={
            location.name || intl.formatMessage(i18ncontact.map)
          }
        />
      </a>
    </div>
