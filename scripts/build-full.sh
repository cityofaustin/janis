...
# export CMS_MEDIA='https://joplin-austin-gov-static.s3.amazonaws.com/review/import-everything/media'
export CMS_API='https://joplin-pr-import-everything.herokuapp.com/api/graphql'
export CMS_MEDIA='https://joplin-austin-gov-static.s3.amazonaws.com/review/import-everything/media'
